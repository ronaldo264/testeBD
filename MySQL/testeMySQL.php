<?php
	...
	require_once 'execute.php';
			...
			<style>
			 ...
			 $sqlMySQL = "select * from funcionario f inner join empresa e inner join trabalho t on(f.id_emp_func = e.id_emp AND t.id_trab = e.id_trab_emp) inner join endereco en on(f.id_end_func = en.id_end) WHERE f.id_emp_func >= 5 and f.id_func <=1000 order by f.id_func";
